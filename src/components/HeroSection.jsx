  ...
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div
          className="order-1 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10"
          data-aos="fade-right"
        ...
        <div
          className="order-2 lg:order-2 from-[#0d1224]  relative rounded-lg  bg-gradient-to-r to-[#0a0d37]"
          style={{ border: "1px solid #1b2c68a0" }}
          data-aos="fade-left"
          data-aos-duration="1000"
          data-aos-delay="50"
          data-aos-easing="ease-in-out"
